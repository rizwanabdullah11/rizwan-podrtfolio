...
export default function Projects() {
  return (
    ...
    >
      ...
      >
        {/* Background Elements */}
        <div className="absolute top-0 right-0 w-80 h-80 bg-gradient-to-br from-emerald-500/5 to-cyan-500/5 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 w-64 h-64 bg-gradient-to-br from-cyan-500/5 to-emerald-500/5 rounded-full blur-2xl"></div>
